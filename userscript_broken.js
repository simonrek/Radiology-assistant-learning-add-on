  ...
  class UIManager {
    ...
    createTutorPanel() {
      ...
      panel.innerHTML = `
                ...
                <!-- Modern Combined Stats & Settings Section -->
                <div class="tutor-bottom-panel" style="position: absolute; bottom: 60px; left: 0; right: 0; background: #0f2544; transition: all 0.3s ease;">
                    <!-- Stats & Settings Toggle Bar -->
                    <div style="display: flex; border-top: 1px solid #2c4a7c;">
                        <button id="stats-toggle" class="panel-tab" style="flex: 1; padding: 12px 15px; background: #0f2544; border: none; color: #7198f8; cursor: pointer; font-size: 12px; border-right: 1px solid #2c4a7c; transition: all 0.2s ease;">
                            📊 Stats
                        </button>
                        <button id="settings-toggle" class="panel-tab" style="flex: 1; padding: 12px 15px; background: #0a1f3d; border: none; color: #ffffff; cursor: pointer; font-size: 12px; transition: all 0.2s ease;">
                            ⚙️ Settings
                        </button>
                    </div>
                    
                    <!-- Stats Content -->
                    <div id="stats-panel" style="padding: 15px; background: #0a1f3d; display: none; transition: all 0.3s ease;">
                    ...
                    <!-- Settings Content -->
                    <div id="settings-panel" style="padding: 15px; background: #0a1f3d; display: none; transition: all 0.3s ease;">
                        <!-- API Key Management -->
                ...
                <div class="tutor-footer" style="position: absolute; bottom: 0; left: 0; right: 0; padding: 10px 15px; border-top: 1px solid #2c4a7c; background: #0f2142; font-size: 11px; color: #95a5a6; text-align: center; line-height: 1.4;">
                    Made with ❤️ for radiology<br><br><strong>CAUTION: AI can hallucinate and provide incorrect information. Always verify AI-generated content with trusted sources.</strong><br>
                    <a href="https://www.simonrekanovic.com" target="_blank" style="color: #7198f8; text-decoration: none;">Made by simonrekanovic.com</a> • 
